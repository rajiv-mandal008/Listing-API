...
namespace Aryeo_Listing_Api.Controllers
{
    ...
    public class AryeoController : ControllerBase
    {
        ...
        public IEnumerable<string> Get(string? address = null, string? agent = null, string? status = null, bool? active = null, decimal? price_gte = null,
            ...
            int? bedrooms_lte = null, decimal? bathrooms_gte = null, decimal? bathrooms_lte = null)
        {
            ...
            _listingProvider.GetLisingList(RqListing);
            yield return "";
        }
    }
}